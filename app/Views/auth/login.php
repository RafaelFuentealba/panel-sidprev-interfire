        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <form class="card auth_form" action="<?= site_url('auth/ingresar'); ?>" method="POST" autocomplete="off">
                    ...
                    <?php
                    if (!empty(session()->getFlashdata('register-success'))) :
                    ?>
                        <div class="alert alert-success text-center"><?= session()->getFlashdata('register-success'); ?></div>
                    <?php
                    endif
                    ?>
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="card">
                    <img src="<?= base_url('public/images/signin.svg'); ?>" alt="Iniciar sesión"/>
                </div>
            </div>
        </div>
    </div>
