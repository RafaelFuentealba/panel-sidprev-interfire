        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/beta/usuario/'.$userData['usuario_id']) ?>"><i class="zmdi zmdi-accounts-alt"></i> Usuarios beta</a></li>
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12">
                    <div class="card mcard_3">
                        <div class="body">
                            <img src="<?= base_url('public/uploads/users/'.$userData['img_perfil']); ?>" class="rounded-circle shadow">
