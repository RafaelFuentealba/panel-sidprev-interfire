        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/gestion/usuario/'.$userData['usuario_id']) ?>"><i class="zmdi zmdi-accounts-alt"></i> Gestionar usuarios</a></li>
                        <li class="breadcrumb-item active">Información de usuario</li>
                    </ul>
            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12">
                    <div class="card mcard_3">
                        <div class="body">
                            <img src="<?= base_url('public/uploads/users/'.$userData['img_perfil']); ?>" class="rounded-circle shadow">                            <h4 class="m-t-10"><?= $userData['nombre'].' '.$userData['apellido']; ?></h4>                            
                            <div class="row">
                                <div class="col-12">
