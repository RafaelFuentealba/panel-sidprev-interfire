        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/gestion/usuarios') ?>"><i class="zmdi zmdi-accounts-alt"></i> Gestionar usuarios</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button onclick="blockUser(this)" value="<?= $user['usuario_id'] ?>" class="btn btn-danger waves-effect waves-float btn-sm waves-red" title="Bloquear usuario"><i class="zmdi zmdi-close"></i></button>
                                            </td>
                                        </tr>
                                        <?php
                                        }
